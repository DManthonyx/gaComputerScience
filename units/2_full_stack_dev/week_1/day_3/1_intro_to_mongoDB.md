...
- Data Modeling - Intro
- Data Modeling in MongoDB - Embedding Subdocuments - Referencing Documents
...
**YOU DO: Let's add another person to the _people_ collection. But this time, add an additional field called _birthDate_ and assign it a date value with something like this: _birthDate: new Date('3/21/1981')_**
